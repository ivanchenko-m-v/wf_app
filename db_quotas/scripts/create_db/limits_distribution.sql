--РАСЧЁТНЫЕ КВОТЫ ПОЛЬЗОВАТЕЛЕЙ НА ВЫЛОВ ВБР
...
(
    ...
    CONSTRAINT [PK_limits_distribution] PRIMARY KEY ([id_distribution_lim], [id_declarant], [id_basin], [date], [id_regime], [id_region], [id_fish], [id_subject], [id_unit])
)
