...
// Автор: Иванченко М.В.
// Дата начала разработки:  20-03-2017
...
namespace cfmc.quotas
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            using( Mutex mutex = new Mutex( true, "cfmc.quotas.forms.REPORT_WBR_CATCH", out createdNew ) )
            {
                if( createdNew )
                {
                    //check config file
        ...
        private static void show_main_form( )
        {
            ...
            Application.Run( new cfmc.quotas.forms.form_report_catch( ) );
        }
