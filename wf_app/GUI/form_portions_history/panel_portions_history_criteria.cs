...
namespace cfmc.quotas_app
{
    public class panel_portions_history_criteria : Panel
    {
        ...
        public panel_portions_history_criteria()
        {
            ...
            this.SizeChanged += panel_portions_history_criteria_SizeChanged;
            this.FontChanged += panel_portions_history_criteria_FontChanged;
        }
...
//            this.calc_layout_columns_width();
        ...
        private void init_layout_row_year()
        {
            ...
            lbl.Text = resource_panel_portions_history_criteria._cbx_year;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_LABEL_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            this._cbx_year.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            this._layout_table.Controls.Add(
                                            this._cbx_year,
                                            panel_portions_history_criteria._COL_TEXT_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._num_percent;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_PERCENT_LABEL_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            this._num_percent.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            this._num_percent.Value = panel_portions_history_criteria._PERCENT_DEFAULT_;
            this._layout_table.Controls.Add(
                                            this._num_percent,
                                            panel_portions_history_criteria._COL_PERCENT_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._cbx_stat;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_CATCH_LABEL_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            this._cbx_stat.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            this._layout_table.Controls.Add(
                                            this._cbx_stat,
                                            panel_portions_history_criteria._COL_CATCH_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            ...
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_SPACE_,
                                            panel_portions_history_criteria._ROW_YEAR_
                                           );
            this._layout_table.SetColumnSpan(lbl, panel_portions_history_criteria._SPAN_COLUMNS_SPACE_YEAR_);
        }
        /// <summary>
        ...
        {
            System.Windows.Forms.Label lbl = new Label( );
            lbl.Text = resource_panel_portions_history_criteria._x_subject;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl, 
                                            panel_portions_history_criteria._COL_LABEL_,
                                            panel_portions_history_criteria._ROW_SUBJECT_
                                           );
            ...
            this._btn_subject.Text = resource_panel_portions_history_criteria._btn_select_text;
            this._tooltip.SetToolTip(this._btn_subject, resource_panel_portions_history_criteria._btn_subject_tip);
            this._btn_subject.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            this._layout_table.Controls.Add(
                                            this._btn_subject,
                                            panel_portions_history_criteria._COL_SELECT_,
                                            panel_portions_history_criteria._ROW_SUBJECT_
                                           );
            this._btn_subject_clear.Text = resource_panel_portions_history_criteria._btn_clear_text;
            this._tooltip.SetToolTip(this._btn_subject_clear, resource_panel_portions_history_criteria._btn_clear_tip);
            ...
            this._layout_table.Controls.Add(
                                            ...
                                            panel_portions_history_criteria._COL_CLEAR_,
                                            panel_portions_history_criteria._ROW_SUBJECT_
                                           );
        }
        /// <summary>
        ...
        {
            System.Windows.Forms.Label lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._x_regime;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
            ...
            this._btn_regime.Text = resource_panel_portions_history_criteria._btn_select_text;
            this._tooltip.SetToolTip(this._btn_regime, resource_panel_portions_history_criteria._btn_regime_tip);
            ...
            this._btn_regime_clear.Text = resource_panel_portions_history_criteria._btn_clear_text;
            this._tooltip.SetToolTip(this._btn_regime_clear, resource_panel_portions_history_criteria._btn_clear_tip);
        ...
        {
            System.Windows.Forms.Label lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._x_region;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
            ...
            this._btn_region.Text = resource_panel_portions_history_criteria._btn_select_text;
            this._tooltip.SetToolTip(this._btn_region, resource_panel_portions_history_criteria._btn_region_tip);
            ...
            this._btn_region_clear.Text = resource_panel_portions_history_criteria._btn_clear_text;
            this._tooltip.SetToolTip(this._btn_region_clear, resource_panel_portions_history_criteria._btn_clear_tip);
        ...
        {
            System.Windows.Forms.Label lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._x_fish;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top | AnchorStyles.Bottom;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_LABEL_,
                                            panel_portions_history_criteria._ROW_FISH_
                                           );
            ...
            this._btn_fish.Text = resource_panel_portions_history_criteria._btn_select_text;
            this._tooltip.SetToolTip(this._btn_fish, resource_panel_portions_history_criteria._btn_fish_tip);
            ...
            this._btn_fish_clear.Text = resource_panel_portions_history_criteria._btn_clear_text;
            this._tooltip.SetToolTip(this._btn_fish_clear, resource_panel_portions_history_criteria._btn_clear_tip);
        ...
        {
            System.Windows.Forms.Label lbl = new Label();
            lbl.Text = resource_panel_portions_history_criteria._x_declarant;
            lbl.Anchor = AnchorStyles.Right | AnchorStyles.Top;
            lbl.AutoSize = true;
            this._layout_table.Controls.Add(
                                            lbl,
                                            panel_portions_history_criteria._COL_LABEL_,
                                            panel_portions_history_criteria._ROW_DECLARANT_
                                           );
            ...
            this._btn_declarant.Text = resource_panel_portions_history_criteria._btn_select_text;
            this._tooltip.SetToolTip(this._btn_declarant, resource_panel_portions_history_criteria._btn_declarant_tip);
            ...
            this._btn_declarant_clear.Text = resource_panel_portions_history_criteria._btn_clear_text;
            this._tooltip.SetToolTip(this._btn_declarant_clear, resource_panel_portions_history_criteria._btn_clear_tip);
        ...
        /// <summary>
        /// panel_portions_history_criteria_SizeChanged(object sender, EventArgs e)
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void panel_portions_history_criteria_SizeChanged(object sender, EventArgs e)
        {
            //this.calc_layout_columns_width();
        }
        /// <summary>
        /// panel_portions_history_criteria_FontChanged(object sender, EventArgs e)
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void panel_portions_history_criteria_FontChanged(object sender, EventArgs e)
        {
            //this.calc_min_size();
